...
public abstract class GameInput : MonoBehaviour
{
    ...
    // }
    protected abstract void InitializeGameControl();
    ...
    protected void SetupCallbacks(InputAction interactAction, InputAction operateAction, InputAction pauseAction)
    {
        interactAction.performed += Interact_Performed;
        operateAction.performed += Operate_Performed;
    ...
    //     return "";
    // }
    public abstract void ReBinding(BindingType bindingType, Action onComplete);

    public abstract string GetBindingDisplayString(BindingType bindingType);
    ...
    protected virtual void Operate_Performed(InputAction.CallbackContext obj)
    {
        OnOperateAction?.Invoke(this, EventArgs.Empty);
    }

    protected virtual void Interact_Performed(InputAction.CallbackContext obj)
    {
        OnInteractAction?.Invoke(this, EventArgs.Empty);
    }
    ...
    public abstract Vector3 GetMovementDirectionNormalized();
